...
export default function RoleBasedDashboard() {
  ...
  }, [userData, selectedCluster, selectedBranch]);
    ...
    <div className="space-y-8 texture-bg">
      ...
      <div className="card texture-card">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div>
            ...
            <p className="text-gray-600">Real-time data filtered by Role, Cluster, and Branch</p>
          </div>
      ...
      {selectedSheet && dashboardData && dashboardData.data && dashboardData.data[selectedSheet] && (
        <div className="card texture-card">
          ...
          {/* Chart */}
          <div className="mb-8">
            <h3 className="text-lg font-medium text-gray-800 mb-4">Real-time Chart View</h3>
            {generateChartData(selectedSheet) ? (
              <div className="h-96">
                <DataChart 
                  ...
                  title={`${selectedSheet} - ${selectedCluster !== "All Clusters" ? selectedCluster : "All Clusters"} - ${selectedBranch !== "All Branches" ? selectedBranch : "All Branches"}`}
                  height={350}
                />
              </div>
            ) : (
